 ...
 */
contract UCCollateralExchange is ReentrancyGuard {
    ...
    constructor(address _ucTokenAddress, address _ucCrawlingBandAddress, address _collateralAddress) public {
        ...
        // TODO: add this collateral contract to list of acceptable contracts to interact with UC framework
    }
    ...
    function newSaleOrder(uint _amount, uint _price, uint _expirationInMinutes) public returns (bool) {
        ...
        bytes32 key = keccak256(msg.sender, amount, price, expirationInMinutes, block.number);
    ...
    function removeSaleOrder(bytes32 _key) public {
        ...
        SaleOrder storage o = saleOrders[_key];
        require(o.addr = msg.sender, "order doesn't belong to sender");
        // TODO: transfer UCs back to seller
